                ...
                <div className="space-y-5">
                    ...
                    <div className="bg-white/10 rounded-lg p-4 space-y-2">
                        <p className="text-lg text-white text-center">
                            📌 <strong className="text-2xl">Atenção:</strong> O
                            envio do vídeo é feito via{' '}
                        ...
                        <p className="text-sm md:text-sm text-white/80 text-center">
                            ...
                            administrador e o status da aula será atualizado
                            aqui na plataforma.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        {loading ? 'Enviando...' : 'Enviar vídeo pelo WhatsApp'}
                    </button>
                </div>
            </Card>
        </div>
