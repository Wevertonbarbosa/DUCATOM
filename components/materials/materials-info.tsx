                ...
                <div className="relative w-32 h-32 md:w-40 md:h-40">
                    <div className="absolute inset-0 bg-[#7a8ea0] rounded-2xl flex items-center justify-center">
                        ...
                        <div className="absolute -bottom-2 -right-2 bg-[#6b7fa0] rounded-full p-3 md:p-4 shadow-lg">
                            <div className="w-0 h-0 border-l-[8px] md:border-l-[10px] border-l-white border-t-[6px] md:border-t-[8px] border-t-transparent border-b-[6px] md:border-b-[8px] border-b-transparent ml-1" />
                        </div>
                    </div>
                </div>
            </div>
